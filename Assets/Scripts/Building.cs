...
public class Building : MonoBehaviour
{
    ...
    void Start()
    {
        gameObject.transform.Translate(Vector3.up * triangleSize.y);
        CreateBuilding();
    }
    ...
    public void UpdateBuldingSize(Vector3 newBuildingSize)
    {
        triangleSize = newBuildingSize;
    }
    ...
    private void CreateBuilding()
    {
        ...
        meshRenderer.materials = materialsBuilder.MaterialsListBlack().ToArray();
    }
}
